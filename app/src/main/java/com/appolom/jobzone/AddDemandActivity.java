...
public class AddDemandActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_offer:
                        Intent intent = new Intent(AddDemandActivity.this, offerListActivity.class);
                        intent.putExtra("lat", lat);
                        intent.putExtra("lng", lng);
                        startActivity(intent);
                        break;
                    case R.id.navigation_demand:
                        Intent intent2 = new Intent(AddDemandActivity.this, demandListActivity.class);
                        intent2.putExtra("lat", lat);
                        intent2.putExtra("lng", lng);
                        startActivity(intent2);
                        break;
                    case R.id.navigation_map:
                        Intent intent3 = new Intent(AddDemandActivity.this, mapOfferActivity.class);
        ...
        itemRef = database.getReference(getString(R.string.demand));
      ...
      //  itemRef.child("items").push();
        ...
        sentPI = PendingIntent.getBroadcast(AddDemandActivity.this, 0, new Intent(SENT), 0);
        deliveredPI = PendingIntent.getBroadcast(AddDemandActivity.this, 0, new Intent(DELIVERED), 0);
        ...
        btnSendSMS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(AddDemandActivity.this, android.Manifest.permission.SEND_SMS)
                        != PackageManager.PERMISSION_GRANTED)
                {
                    ActivityCompat.requestPermissions(AddDemandActivity.this, new String [] {android.Manifest.permission.SEND_SMS},
...
// new adreess
            ...
            Toast.makeText(AddDemandActivity.this,  getString(R.string.try_again) , Toast.LENGTH_LONG).show();

        }

        }catch(Exception e)
        {
            Toast.makeText(AddDemandActivity.this, getString(R.string.missing_a_field), Toast.LENGTH_LONG).show();
        }
